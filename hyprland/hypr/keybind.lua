...
hl.bind(mainMod .. " + F2", hl.dsp.exec_cmd(colorPickerCmd))                      -- Color picker
hl.bind(mainMod .. " + F11", hl.dsp.exec_cmd(muteCmd))                            -- Toggle micro
hl.bind(mainMod .. " + F12", hl.dsp.exec_cmd(screenShotCmd))                      -- Screenshot zone
