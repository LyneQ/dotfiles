...
# Mise à jour yay (AUR)
echo -e "${GREEN}-- [1/3] Mise à jour des paquets AUR avec yay...${RESET}"
yay -Syu --noconfirm

# Mise à jour hyprpm (plugins Hyprland)
echo -e "${GREEN}-- [2/3] Mise à jour des plugins Hyprland avec hyprpm...${RESET}"
hyprpm update

# Mise à jour pacman (paquets officiels)
echo -e "${GREEN}-- [3/3] Mise à jour des paquets officiels avec pacman...${RESET}"
